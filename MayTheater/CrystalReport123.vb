...
Public Class CrystalReport123
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MayTheater.CrystalReport123.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport123
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport123 = New CrystalReport123()
        rpt.Site = Me.Site
        Return rpt
    End Function
