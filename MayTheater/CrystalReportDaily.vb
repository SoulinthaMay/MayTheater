...
Public Class CrystalReportDaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MayTheater.CrystalReportDaily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportDaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportDaily = New CrystalReportDaily()
        rpt.Site = Me.Site
        Return rpt
    End Function
